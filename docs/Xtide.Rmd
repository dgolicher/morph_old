...
site5<-'St. Catherine Cove, Unimak Island, Alaska'
...
d2<-data.frame(station=4,nm="Amak",time=tides$Time,ht=tides$TideHt)
d<-rbind(d,d2)
tides<-get_tides(site5)
d2<-data.frame(station=5,nm="StCat",time=tides$Time,ht=tides$TideHt)
d<-rbind(d,d2)
